...
@section('content')
    ...
    <div class="container">
        @if(session('lang')=='ja')
            <div class="row" style="padding:80px 0px;">
                <div class="col-lg-12 col-md-12">
                    <h1 class="mt-4">{{$detail->title_ja}}</h1>
                    <hr>
                    <p>Posted on {{$detail->created_at}}</p>
                    <hr>
                        <img class="img-fluid rounded" src="/assets/images/blog/{{$detail->image}}" style="height: 400px;">
                    <hr>
                    <p class="lead">{!! $detail->description_ja !!}</p> 
                </div>
                <hr>
        ...
        <div class="row" style="padding:80px 0px;">
            <div class="col-lg-12 col-md-12">
                <h1 class="mt-4">{{$detail->title_pt}}</h1>
                <hr>
                <p>Posted on {{$detail->created_at}}</p>
                <hr>
                    <img class="img-fluid rounded" src="/assets/images/blog/{{$detail->image}}" style="height: 400px;">
                <hr>
                <p class="lead" style="margin-top: 20px;">{!! $detail->description_pt !!}</p> 
            </div>
            <hr>
