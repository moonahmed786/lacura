...
@section('content')
        ...
        <div class="user-profile layout-spacing">
            <div class="widget-content widget-content-area" style="height: 874px;">
                ...
                <div class="text-center user-info">
                    <img alt="{{auth()->user()->name}}" class="img-responsive"
    ...
    <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
        ...
        <div class="skills layout-spacing  widget-content-area widget-content">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="">@lang('user_profile.Personal Document is Required to continue').</h3>
                    <p class="text-danger" >@lang('user_profile.All fields are Required')*</p>
                </div>
                <div class="col-md-6">
                    <a class="mt-2 edit-profile btn btn-info pull-right ml-2" href="{{route('user.profile')}}"> @lang('user_profile.Profile Settings')<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path> <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg></a>
                </div>
            ...
            <div class=" ">
                ...
                <div class="info">
                    ...
                    <form class="contact-form" method="POST" action="{{route('user.withdraw.settings.update')}}"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control mb-4"
                                                           ...
                                                           value="{{Auth::user()->payoneer_username}}{{old('payoneer_username')}}" name="payoneer_username" >
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control mb-4" name="payoneer_email"
                                                                placeholder="@lang('user_profile.payoneer_email')"
                                                               value="{{Auth::user()->payoneer_email}}{{old('payoneer_email')}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="stripe">@lang('user_profile.Stripe Name')<span
                                                                class="requred">*</span></label>
                                                        <input type="text" class="form-control mb-4"
                                                               placeholder="@lang('user_profile.Stripe Name')"
                                                               value="{{Auth::user()->stripe}}{{old('stripe')}}" name="stripe" >
                                                    </div>

                                                </div>
                                                <div class="col-sm-6 mt-4">
                                                    <div class="form-group">
                                                        <label for="userLanguage">@lang('user_profile.stripe_email')<span
                                                                class="requred">*</span></label>
                                                        <input type="email" class="form-control mb-4"
                                                               placeholder="@lang('user_profile.stripe_email')"
                                                               value="{{Auth::user()->stripe_email}}{{old('stripe_email')}}" name="stripe_email" >
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <p class="text-danger">@lang('user_profile.Bank Account Details')</p>
                                                    <div class="form-group" >
                                                        <label for="InputUsername" class="text-danger" >@lang('user_profile.Account Holder Name')<span
                                                                class="requred">*</span></label>
                                                        <input type="text" class="form-control mb-4" name="account_name"
                                                               value="{{Auth::user()->account_name}} {{old('account_name')}}"
                                                ...
                                                <div class="col-md-6 mt-4">
                                                    <div class="form-group">
                                                        <label for="InputUsername " class="text-danger" >@lang('user_profile.Bank Account Number')<span
                                                                class="requred">*</span></label>
                                                        <input type="text" class="form-control mb-4" name="bank_account_number"
                                                               value="{{Auth::user()->bank_account_number}}{{old('bank_account_number')}}" placeholder="@lang('user_profile.Bank Account Number')"
                                                               required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="InputMail" class="text-danger">@lang('user_profile.bank_name')<span class="requred">*</span></label>
                                                        <input type="text" id="bank_name" class="form-control mb-4" name="bank_name"
                                                               value="{{Auth::user()->bank_name}} {{old('bank_name')}}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="InputMail" class="text-danger">@lang('user_profile.bank_IBN_number')<span class="requred">*</span></label>
                                                        <input type="text" id="bank_name" class="form-control mb-4" name="bank_IBN_number"
                                                               value="{{Auth::user()->bank_IBN_number}} {{old('bank_IBN_number')}}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="InputMail" class="text-danger">@lang('user_profile.account_type')<span class="requred">*</span></label>
                                                        <input type="text" id="account_type" class="form-control mb-4" name="account_type"
                                                               value="{{Auth::user()->account_type}}{{old('account_type')}}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="InputMail" class="text-danger" >@lang('user_profile.branch_number')<span class="requred">*</span></label>
                                                        <input type="text" id="branch_number" class="form-control mb-4" name="branch_number"
                                                               value="{{Auth::user()->branch_number}}{{old('branch_number')}}"
                                                ...
                                                <div class="col-md-6">
                                                    @if(!Auth::user()->personal_document)
                                                        <div class="form-group">
                                                            <label for="peronal_document font-weight-bold" style="color: red">@lang('user_profile.Personal Document')</label>
                                                            <input type="file" class="form-control" name="personal_document" style="border-color: red" value="{{old('selfie_document')}}" required>
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                @if(!Auth::user()->selfie_document)
                                                        <div class="form-group">
                                                            <label for="selfie_document font-weight-bold" style="color: red">@lang('user_profile.Selfie with Document')</label>
                                                            <input type="file"  id="selfie_document" class="form-control" name="selfie_document" style="border-color: red" value="{{old('selfie_document')}}" required>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="btc_address" class="text-danger" > @lang('user_profile.BTC Address')<span class="requred">*</span></label>
                                                        <input type="text" id="btc_address" class="form-control mb-4" name="btc_address"
                                                               value="{{Auth::user()->btc_address}}{{old('btc_address')}}"
                                                               placeholder="@lang('user_profile.BTC Address')"
                                                               required>
                                                    </div>
                                                </div>
