                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                @foreach($trans as $data)
                                    <tr @if($data->amount < 0)  style="background-color: #e4afaf !important;" @endif>
                                        <td @if($data->amount < 0)  style="color: black !important;" @endif scope="row">{{date('g:ia \o\n l jS F Y', strtotime($data->created_at))}}</td>
                                        <td @if($data->amount < 0)  style="color: black !important;" @endif>{{__($data->des)}}</td>
                                        <td @if($data->amount < 0)  style="color: black !important;" @endif>{{__($general->currency_sym)}} {{abs($data->amount)}}</td>
                                        <td @if($data->amount < 0)  style="color: black !important;" @endif>{{__($general->currency_sym)}} {{round($data->balance,4)}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
