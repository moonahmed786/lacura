                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">@lang('deposit.Gateway')</th>
                                    <th class="text-center">@lang('deposit.TRX ID')</th>
                                    <th class="text-center">@lang('deposit.TRX Time')</th>
                                </tr>
                                </thead>
                                <tbody style="text-align: center">
                                @if(count($deposit)==0)
                                    <tr>
                                        <td colspan="4"><h2>@lang('deposit.No Data Available')</h2></td>
                                    </tr>
                                @endif
