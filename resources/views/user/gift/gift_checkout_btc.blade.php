...
{{--                                    </form>--}}
                                    <form action="https://www.coinpayments.net/index.php" method="post">
                                        ...
                                        <input type="hidden" name="merchant" value="69375f027566f3fa6023cbb71e498386">
                                        <input type="hidden" name="item_name" value="gift">
                                        <input type="hidden" name="item_number" value="1">
                                        <input type="hidden" name="custom" value="gift">
                                        <input type="hidden" name="invoice" value="{{$code}}">
                                        <input type="hidden" name="currency" value="LTCT">
                                        <input type="hidden" name="amountf" value="{{$total}}">
                                        <input type="hidden" name="quantity" value="1">
                                        <input type="hidden" name="allow_quantity" value="0">
                                        <input type="hidden" name="want_shipping" value="0">
                                        <input type="hidden" name="success_url" value="https://comupool.com/users/gift/list">
                                        <input type="hidden" name="cancel_url" value="https://comupool.com/cancel">
                                        <input type="hidden" name="ipn_url" value="https://comupool.com/callback/ipn/results/gift/code">
