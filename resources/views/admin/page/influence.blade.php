            ...
            @endif
                <div class="">
                    <div class="pull-right mb-2">
                        ...
                        <a class="btn btn-success" href="{{route('module.language-manage',['influence-of-work','Influence of Work Page','influence-of-work.front'])}}"><i class="icon fa fa-language"></i>Influence of Work Page Translations </a>
            ...
            <div class="tile">
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('page.update')}}">
                        {{ csrf_field() }}
                        <input type="hidden" name="key" value="influence">
                        <div class="form-body">
                            <div class="row">
