            ...
            @endif
                <div class="">
                    <div class="pull-right mb-2">
                        ...
                        <a class="btn btn-success" href="{{route('module.language-manage',['mental-trauma','Mental Trauma Page','mental-trauma.front'])}}"><i class="icon fa fa-language"></i>Mental Trauma Page Translations </a>
            ...
            <div class="tile">
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('page.update')}}">
                        {{ csrf_field() }}
                        <input type="hidden" name="key" value="mental">
                        <div class="form-body">
                            <div class="row">
