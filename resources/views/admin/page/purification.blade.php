            ...
            @endif
                <div class="">
                    <div class="pull-right mb-2">
                        ...
                        <a class="btn btn-success" href="{{route('module.language-manage',['purification','Purification Soul Page','purification-soul.front'])}}"><i class="icon fa fa-language"></i>Purification Soul Page Translations </a>
            ...
            <div class="tile">
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('page.update')}}">
                        {{ csrf_field() }}
                        <input type="hidden" name="key" value="purification">
                        <div class="form-body">
                            <div class="row">
