            ...
            @endif
                <div class="">
                    <div class="pull-right mb-2">
                        ...
                        <a class="btn btn-success" href="{{route('module.language-manage',['Alcoholics&Addictions','Alcoholics and Addictions Page','alcoholics-and-addictions.front'])}}"><i class="icon fa fa-language"></i>Alcoholics and Addictions Page Translations </a>
            ...
            <div class="tile">
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('page.update')}}">
                        {{ csrf_field() }}
                        <input type="hidden" name="key" value="alcoholics">
                        <div class="form-body">
                            <div class="row">
...
{{--                                 @endphp--}}
{{--                             </td>--}}
{{--                                <td><a href="#satModal{{$comment->id}}" data-toggle="modal" class="btn btn-primary">Change Status</a></td>--}}
{{--                                <td></td>--}}
{{--                                <td><a href="#viewModal{{$comment->id}}" data-toggle="modal" class="btn btn-primary">View</a></td>--}}
{{--                                 <td><a href="#delModal{{$comment->id}}" data-toggle="modal" class="btn btn-danger">Delete</a></td>--}}
{{--                            </tr>--}}
{{--                            <div id="satModal{{$comment->id}}" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">--}}
...
{{--                                        <form role="form" action="{{route('comment.changestat',$comment->id)}}" method="post">--}}
{{--                                            @csrf--}}
...
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div id="viewModal{{$comment->id}}" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">--}}
{{--                                <div class="modal-dialog" role="document">--}}
{{--                                    <div class="modal-content">--}}
{{--                                        <div class="modal-header">--}}
...
{{--                                </div>--}}
{{--                            </div>--}}
{{--                             <div id="delModal{{$comment->id}}" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">--}}
{{--                            <div class="modal-dialog" role="document">--}}
{{--                                <div class="modal-content">--}}
{{--                                    <div class="modal-header">--}}
