        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="tile-body">
                    ...
                    <form class="form-inline" action="{{ route('inslider.setting') }}" method="POST">
                        @csrf
                        <div class="col-md-4 mb-3">
                            <h6> Footer Slider </h6>
                            <input data-toggle="toggle" data-onstyle="success" data-on="Enable" data-off="Disabled"   data-offstyle="danger"
                                   data-width="100%" type="checkbox"
                                   name="footer_slider_enable" {{ $general->footer_slider_enable == "on" ? 'checked' : '' }}>
                        </div>
{{--                        <div class="form-group col-md-12 mb-4">--}}
{{--                            <label><strong class="mr-4">Slide Text <small class="text-info">(Japaneese)</small></strong></label>--}}
{{--                            <textarea class="form-control col-md-12 ckEdit" name="in_slider_text" placeholder="Slider Text"--}}
{{--                                      rows="5" style="width: 100%">{{ $general->in_slider_text }}</textarea>--}}
{{--                        </div>--}}
{{--                        <div class="form-group col-md-12 mb-4">--}}
{{--                            <label><strong class="mr-4">Slide Text <small--}}
{{--                                        class="text-info">(Portugueese)</small></strong></label>--}}
{{--                            <textarea class="form-control col-md-12 ckEdit" name="in_slider_textpt"--}}
{{--                                      placeholder="Slider Text" rows="5"--}}
{{--                                      style="width: 100%">{{ $general->in_slider_textpt }}</textarea>--}}
{{--                        </div>--}}
                        <div class="col-md-12 mb-3">
                            <strong class="mr-4">Slide Speed </strong>
                            <input type="number" class="form-control mr-4" name="in_slider_speed"
                                   value="{{ $general->in_slider_speed }}" placeholder="Slider Speed">
                            <strong class="mr-4">Number of Slides</strong>
                            <input type="number" class="form-control mr-4" name="in_slider_number"
                                   value="{{ $general->in_slider_number }}" placeholder="">
                            <strong class="mr-4">Show Method </strong>
                            <select name="in_slider_show_method" class="form-control">
                                <option value="random"
                                        class="form-control" {{$general->in_slider_show_method == 'random'? 'selected': ''}}>
                                    Random
                                </option>
                                <option value="newest"
                        ...
                        <div class="col-md-12 ">
                            ...
                            <input type="number" class="form-control mr-4" name="in_slidesPerView"
                                   value="{{ $general->in_slidesPerView }}" placeholder="1 or 2 Recommended">
                            <strong class="mr-4">Autoplay Delay</strong>
                            <input type="number" class="form-control mr-4" name="in_autoplay_delay"
                                   value="{{ $general->in_autoplay_delay }}" placeholder="400 to 600 Recommended ">
                            <strong class="mr-4">Slider Loop </strong>
                            <select name="in_slider_loop" class="form-control">
                                <option value="1"
                ...
                <form action="{{route('inslider.remove.multi')}}" method="post">
                ...
                <div class="tile-body">
                    <div class="table-responsive">
                        ...
                        <div class="caption font-dark pull-left">
                            ...
                            <a href="{{ route('inslider.new') }}" class="btn btn-primary btn-icon bold"><i
                                    ...
                                    @foreach($sliders as $data)
                                        <tr>
                                            ...
                                            <td style="max-width: 160px"><img
                                                    src="{{ asset('assets/images/inslider') .'/'. $data->image_name }}"
                                                    alt="Slider Image" style="width: 100%"></td>
                                            <td>{{ asset('assets/images/inslider') .'/'. $data->image_name }}</td>
                                            <td>
{{--                                                <button type="button" class="btn btn-danger btn-icon removeBtn"--}}
{{--                                                        data-id="{{ $data->id }}"><i class="fa fa-trash"></i>Remove--}}
{{--                                                </button>--}}
                                                <span class="removeItem" data-id="{{ $data->id }}" data-toggle="tooltip" data-title="Delete"> </span><input type="checkbox" name="check-{{$data->id}}" class="my_checkbox">
                                            </td>
                                        </tr>
                                    @endforeach
    ...
    <div class="modal fade" id="removeSlideModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('inslider.remove') }}" method="POST">
                        @csrf
