                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group pranto col-md-12">
                                    ...
                                    <input type="text"  name="color_two"  class="form-control" id="sec_color" value="#{{$general->color_two}}">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control" name="lang">
                                    <option {{ $general->lang == "en" ? 'selected' : '' }} value="en">English</option>
                                    <option {{ $general->lang == "ja" ? 'selected' : '' }} value="ja">Japanese</option>
                                    <option {{ $general->lang == "pt-br" ? 'selected' : '' }} value="pt-br">Portuguese</option>
                                </select>
                            </div>
                            <div class="col-md-2">
