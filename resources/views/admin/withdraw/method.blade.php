...
@section('body')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="tile-body">
                    <form action="{{ route('withdraw.rule') }}" method="POST">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <strong>Error Message </strong>
                                <input type="text" class="form-control" name="nominee_error" value="{{ $general->nominee_error }}" required>
                            </div>
                            <div class="form-group col-md-4">
                                <strong>Minimum Affiliate Nomination</strong>
                                <input type="number" class="form-control" name="nominee" value="{{ $general->nominee }}" required>
                            </div>
