                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class=""><a href="#appModal" data-toggle="modal" id="approve" data-id="{{$data->id}}" data-detail="{{$data->detail}}" data-amount="{{$data->method_cur_amount}}" data-cur="{{$data->withdraw_method->currency}}" class=" btn btn-success d-block">Approve</a></li>
                                            <li class=""><a href="#rejetModal" data-toggle="modal" id="reject" data-id="{{$data->id}}" data-amount="{{$data->amount}}" class="btn btn-danger  d-block">Reject</a></li>
{{--                                            <li class="dropdown-item"> <a href="#rejetModal" data-toggle="modal" id="check_user_info" data-id="{{$data->id}}"  class="btn btn-danger btn-sm">User Info</a></li>--}}
                                        </ul>
                                    </div>
