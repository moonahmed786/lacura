                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="tile">
                                ...
                                <strong class="lead">REFERRAL WITHDRAW RULES</strong>
                                <br>
                                <br>
                                <div class="tile-body">
                                        ...
                                        <div class="form-body mb-4">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <label><strong>Minimum Day to Withdraw</strong></label>
                                                    <div class="input-group">
                                                        <input type="text" name="affiliate_withdraw_day" class="form-control" value="{{$general->affiliate_withdraw_day}}">
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <label><strong>Minimum People for Payment</strong></label>
                                                    <div class="input-group">
                                                        <input type="text" name="affiliate_withdraw_person" class="form-control" value="{{$general->affiliate_withdraw_person}}">
                                                        <div class="input-group-append">
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <label><strong>Payment Release Deadline</strong></label>
                                                    <div class="input-group">
                                                        <input type="text" name="affiliate_withdraw_deadline" class="form-control" value="{{$general->affiliate_withdraw_deadline}}">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text"> Days</div>
                                                        </div>
                                                    </div>
