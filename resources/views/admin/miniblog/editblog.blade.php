...
@section('body')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="tile-body">
                    <form role="form" method="POST" action="{{ route('miniblog.update',$editMiniBlog->id)}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title_pt"
                                   value="{{ $editMiniBlog->title_pt }}">
                        </div>
                        <div class="form-group">
                            <strong>Title(Japanese)</strong>
                            <input type="text" class="form-control" name="title_ja"
                                   value="{{ $editMiniBlog->title_ja }}">
                        </div>


                        <div class="form-group">
                            <strong>Details (Portugese)</strong>
                            <textarea class="form-control ckEdit" name="pt_text"
                                      rows="15">{{ $editMiniBlog->description_pt }}</textarea>

                        </div>
                        <div class="form-group">
                            <strong>Details(Japanese)</strong>
                            <textarea class="form-control ckEdit" name="ja_text"
                                      rows="15">{{ $editMiniBlog->description_ja }}</textarea>

                        </div>
                        <div class="form-group">
                            <label><strong>Tags</strong> <small class="text-info">(optional)</small></label>
                            <input type="text" name="tags" class="form-control" value="{{ $editMiniBlog->tags }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="1" {{ $editMiniBlog->Status==1 ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="0" {{ $editMiniBlog->Status==0 ? 'selected' : '' }}>In Active
                                        </option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" class="form-control">
                                        ...
                                        @foreach($blog_cat as $cat)
                                            <option value="{{$cat->id}}" {{ $editMiniBlog->category_id== $cat->id ? 'selected' : '' }}>
