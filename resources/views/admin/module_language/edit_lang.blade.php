    ...
    <div class="row" id="app">
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="tile-title">(<small>Click Add Translatable Add Put Your Key For Translate</small>)</h3>
                    ...
                    <div class="col-md-4 m-auto text-right">
                        ...
                        <button type="button" data-toggle="modal" data-target="#addModal"
                                class="btn btn-primary">Add Translatable Key
                        </button>
                        <button class="btn btn-success" data-toggle="tooltip" title="@lang('Save')"
...
{{--                                </select>--}}
{{--                            </div>--}}
{{--                            <button type="submit" class="btn btn-primary mb-2">Visit the page</button>--}}
{{--                        </form>--}}
...
{{--                        <small style="color: red">If you import keywords from another language, Your present "{{$la->name}}" all keywords will remove.</small>--}}
                ...
                <div class="tile-body" style="overflow: hidden">
                    <form method="post" action="{{route('module.key-update', [$la->id,$title])}}" id="langForm">
                        {{ csrf_field() }}
                        {{method_field('put')}}
