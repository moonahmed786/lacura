            ...
            <div class="tile">
                <div class="table-responsive">
                    <table class="table">
                            ...
                            <p>Click Edit Button To Update The Keys
                                <a  class="btn btn-primary bold pull-right" target="_blank" href="{{route($route_name)}}" ><i class="fa fa-link" ></i> {{$title}}</a>
                            </p>
                            <br>
                        <thead>
                        <tr>
                        ...
                        @foreach ($social as $product)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{route('module.language-key', [$product->id,$module ,$title,$route_name])}}"><i class="fa fa-code"></i> Keyword Edit</a>
