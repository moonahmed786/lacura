    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull-right mb-2">
                ...
                <a class="btn btn-success" href="{{route('module.language-manage',['faq','FAQ','user.faq.index'])}}"><i class="icon fa fa-language"></i>FAQ Translations </a>
                            ...
                            <div class="card" style="margin: 15px 0;">
                                <div class="card-header" id="headingOne">
                                    <h5 class="mb-0">
                                        ...
                                        @if ($f->status ==1)
                                            <button class="btn  btn-success float-right m-auto"> Active</button>
                                        @else
                                            <button class="btn  btn-warning float-right m-auto"> InActive</button>
