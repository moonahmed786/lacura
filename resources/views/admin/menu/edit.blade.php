...
@section('body')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="tile-body">
                    <form role="form" method="POST" action="{{route('terms.update', $know->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title_jp" value="{{$know->title_jp }}" >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="text_jp" rows="15">{{$know->text_jp }}</textarea>
