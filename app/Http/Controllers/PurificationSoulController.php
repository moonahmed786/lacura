...
class PurificationSoulController extends Controller
{
    public function frontIndex()
    {
        ...
        $know = Blog::inRandomOrder()->take(2)->get();
        $team = Team::all();
        $faq = Faq::all();
    ...
    public function termsIndex($id)
    {
        ...
        $pt = $know->title;
        return view('front.menu_o', compact('pt', 'know'));
    }
    ...
    public function PurificationSoulIndex()
    {
        $pt = "Purification of Soul";
        return view('front.purification-soul', compact('pt'));
    }
    ...
    public function forgotPass(Request $request)
    {
        ...
        if ($user == null) {
            return back()->with('alert', 'auth_pages.Email Not Available');
        } else {
            $to = $user->email;
    ...
    public function passwordReset(Request $request)
    {
        ...
        if ($reset->status == 1) {
            ...
            if ($request->password == $request->password_confirmation) {
                ...
                return back()->with('alert', __('auth_pages.Password Not Matched'));
            }
        }
    }
